...
/* Модификаторы событий OzonTokenModify */

#[ORM\Entity]
#[ORM\Table(name: 'ozon_token_modify')]
#[ORM\Index(columns: ['action'])]
class OzonTokenModify extends EntityEvent
{
    /** ID события */
    #[Assert\NotBlank]
    #[Assert\Uuid]
    #[ORM\Id]
    #[ORM\OneToOne(targetEntity: OzonTokenEvent::class, inversedBy: 'modify')]
    ...
    {
        if ($dto instanceof OzonTokenModifyInterface)
        {
